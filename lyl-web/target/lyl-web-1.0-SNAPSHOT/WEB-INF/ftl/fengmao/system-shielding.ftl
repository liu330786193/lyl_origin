	...
	<div class="menu_dropdown bk_2">
		<dl id="menu-article">
			...
			<dd>
				<ul>
					<li>
						<a href="purchase-list.ftl" title="资讯管理">资讯管理</a>
					</li>
				</ul>
			</dd>
		</dl>
		...
		<dl id="menu-product">
			...
			<dd>
				<ul>
					...
					<li>
						<a href="product-list.ftl" title="产品管理">产品管理</a>
					</li>
				</ul>
			</dd>
		</dl>
		...
		<dl id="menu-system">
			...
			<dd style="display:block">
				<ul>
					<li>
						<a href="system-base.ftl" title="系统设置">系统设置</a>
					</li>
					<li>
						<a href="system-category.ftl" title="栏目管理">栏目管理</a>
					</li>
					<li>
						<a href="system-data.ftl" title="数据字典">数据字典</a>
					</li>
					<li class="current">
						<a href="system-shielding.ftl" title="屏蔽词">屏蔽词</a>
					</li>
					<li>
						<a href="system-log.ftl" title="系统日志">系统日志</a>
					</li>
				</ul>
			</dd>
		</dl>
